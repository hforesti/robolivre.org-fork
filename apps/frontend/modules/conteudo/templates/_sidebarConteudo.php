...
<div class="span2" id="sidebar">
    ...
    <ul class="nav nav-pills nav-stacked">
        ...
        <li <?php echo ($opcao=="documentos")?"class=\"active\"":"" ?>><a href="docs.shtml"><span class="icon-gray icon-file"></span> Documentos <span class="label label-info"></span></a></li>
        <li <?php echo ($opcao=="imagens")?"class=\"active\"":"" ?>><a href="imagens.shtml"><span class="icon-gray icon-picture"></span> Imagens <span class="label label-info"></span></a></li>
        <li <?php echo ($opcao=="videos")?"class=\"active\"":"" ?>><a href="videos.shtml"><span class="icon-gray icon-film"></span> Vídeos <span class="label label-info"></span></a></li>
        <li <?php echo ($opcao=="links")?"class=\"active\"":"" ?>><a href="links.shtml"><span class="icon-gray icon-share-alt"></span> Links <span class="label label-info"></span></a></li>
