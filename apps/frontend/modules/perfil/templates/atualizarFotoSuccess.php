          ...
          <div class="control-group clearfix">
            ...
            <div class="row">
              <div class="preview span2" id="img-preview">
                <img src="/assets/img/rl/170.gif" alt="Sua imagem" id="thumb" class="thumbnail" />
                <img src="/assets/img/rl/60.gif" alt="Sua imagem menos" id="i-medium" class="thumbnail" /> 
                <img src="/assets/img/rl/20.gif" alt="Sua imagem em miniatura" id="i-small" class="thumbnail" />
