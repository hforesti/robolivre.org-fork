<div class="row">
    ...
    <div class="span7">
        <?php if ($usuario->getTipoSolicitacaoAmizade() == Usuarios::SOLICITADA_AMIZADE) { ?>
            <div class="row-fluid">
                <span class="alert span12"><i class="icon-exclamation-sign icon-gray"></i> Aguardando resposta da sua solicitação de amizade</span>
            </div>
        <?php } else if ($ignorado) { ?>
            <div class="row-fluid">
                <span class="alert alert-error span12"><i class="icon-exclamation-sign icon-gray"></i> Usuário ignorado</span>
            </div>
        <?php } ?>
