...
<p>Não é possível fazer tudo sozinho. Confira quem são os nossos parceiros institucionais:</p>
  ...
  <li class="span2">
    <div class="thumbnail">
      <a href="http://www.fing.edu.uy/inco/proyectos/butia/"><img src="<?php echo image_path("/assets/img/rl/logo-butia.png") ?>" alt="Butiá"></a>
        ...
        <p>
            Interessado em também ser nosso parceiro? <a href="<?php echo url_for("contato/index") ?>">Entre em contato conosco</a>.
        </p>
