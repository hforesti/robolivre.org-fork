...
class Ui_Control(object):
    def setupUi(self, Control):
        ...
        self.paraFrente.setGeometry(QtCore.QRect(110, 70, 97, 27))
        ...
        self.giraEsquerda.setGeometry(QtCore.QRect(10, 110, 97, 27))
        ...
        self.giraDireita.setGeometry(QtCore.QRect(210, 110, 97, 27))
        ...
        self.paraTras.setGeometry(QtCore.QRect(110, 160, 97, 27))
