...
class DocumentosTable extends Doctrine_Table {
    ...
    public function getPorId($id) {
        $sql = "
            ...
            WHERE p.tipo_pasta = " . Pastas::TIPO_PASTA_ANEXOS_CONJUNTO . " AND d.id_documento = :id";
        ...
        $documento->setIdDocumento($d['id_documento']);
        $documento->setIdPasta($d['id_pasta']);
        $documento->setHits($d['hits']);
        $documento->setIdUsuario($d['id_usuario']);
        $documento->setNomeArquivo($d['nome_arquivo']);
        $documento->setNomeDocumento($d['nome_documento']);
        $documento->setIsCodigoFonte($d['is_codigo_fonte']);
        return $documento;
    }
